...
function NewRegionModal(props) {
  ...
  return (
    <Modal
      title={__('New Region', 'wps-cookie-consent')}
      onRequestClose={onClose}
    >
      <Flex direction="column">
        <SelectControl
          label={__('Country', 'wps-cookie-consent')}
          ...
          <>
            <Flex direction="row">
              <FlexItem>
                ...
                >
                  {__('Select all', 'wps-cookie-consent')}
                </Button>
              </FlexItem>
              <FlexItem>
                <Button
                ...
                >
                  {__('Deselect all', 'wps-cookie-consent')}
                </Button>
              </FlexItem>
            </Flex>
            <TextControl
              value={searchTerm}
              placeholder={__('Search regions', 'wps-cookie-consent')}
              onChange={(value) => setSearchTerm(value)}
            />
            <Scrollable className="wps-scrollable">
              {subdivisions
