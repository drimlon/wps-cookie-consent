    ...
    return (
      <Panel>
        <PanelBody initialOpen>
          <PanelRow>
            <p>
              {__('There are no consent records yet.', 'wps-cookie-consent')}
            </p>
          </PanelRow>
        </PanelBody>
      </Panel>
  ...
  return (
    <Panel>
      <PanelBody initialOpen>
        <PanelRow>
          <p>
            {__('Here you’ll find all the consent records that have been collected by the plugin.', 'wps-cookie-consent')}
          </p>
        </PanelRow>
        <PanelRow>
              ...
              <Table>
                <Header>
                  <Column style={{ minWidth: '160px' }}>
                    {__('Date', 'wps-cookie-consent')}
                  </Column>
                  <Column style={{ minWidth: '280px' }}>
                    {__('ID', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('URL', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('Location', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('IP address', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('User Agent', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('Necessary consent', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('Analytics consent', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('Targeting consent', 'wps-cookie-consent')}
                  </Column>
                  <Column>
                    {__('Preferences consent', 'wps-cookie-consent')}
                  </Column>
                  <Column style={{ minWidth: '160px' }}>
                    {__('Recorded at', 'wps-cookie-consent')}
                  </Column>
                  <Column style={{ minWidth: '160px' }}>
                    {__('Last update at', 'wps-cookie-consent')}
                  </Column>
                </Header>
                {consentRecords.map((consentRecord) => (
                  <Row>
                    ...
                    <LineWrapColumn>
                      <span>
                        {consentRecord.geo_location || __('Unknown', 'wps-cookie-consent')}
                      </span>
                    </LineWrapColumn>
                    <Column>
                      <span>
                    ...
                    <Column>
                      <span>
                        {consentRecord.necessary_consent
                          ? __('Accepted', 'wps-cookie-consent')
                          : __('Denied', 'wps-cookie-consent')}
                      </span>
                    </Column>
                    <Column>
                      <span>
                ...
                <FlexItem>
                  <Flex>
                    <FlexItem>
                      ...
                      >
                        {__('Export CSV', 'wps-cookie-consent')}
                      </Button>
                    </FlexItem>
                    <FlexItem>
                      <Button
                        ...
                        isBusy={isClearing}
                      >
                        {__('Clear Records', 'wps-cookie-consent')}
                      </Button>
                      <ClearRecordsModal
