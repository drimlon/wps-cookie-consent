      ...
      <Flex align="flex-start" gap={4}>
        <FlexItem>
          <Flex direction="column" gap={4}>
            <FlexItem>
              <RadioControl
                label={__('Language auto-detection strategy', 'wps-cookie-consent')}
                help={state.auto_language === 'browser'
                  ? __('Read the user\'s browser language', 'wps-cookie-consent')
                  : __('Read value from <html lang="..."> of current page', 'wps-cookie-consent')}
                selected={state.auto_language}
                options={[
                  { label: __('Browser', 'wps-cookie-consent'), value: 'browser' },
                  { label: __('document', 'wps-cookie-consent'), value: 'document' },
                ]}
            ...
            <FlexItem>
              <Button
                ...
                isPrimary
              >
                {__('New Language', 'wps-cookie-consent')}
              </Button>
              <NewLanguageModal
        ...
        <FlexItem style={{ flex: '1 1 0px' }}>
          {selectedLanguage && (
            <Panel>
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Consent modal', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Settings modal', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Cookie table headers', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Necessary cookies', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Analytics cookies', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Targeting cookies', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('Preferences cookies', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
              ...
              <PanelBody
                title={`(${formattedSelectedLanguageCode}) ${__('More information block', 'wps-cookie-consent')}`}
                initialOpen
              >
                <PanelRow>
                  <TextControl
