...
function LogsTab() {
  ...
  const fetchLogs = async () => {
    const { logs_route: route, nonce } = wpsCCAdminDetails.api;
  ...
  return (
    <Panel>
      <PanelBody initialOpen>
        <PanelRow>
          <p>
            {__('In this section, you’ll find vital debugging logs. If you encounter any issues, open an issue and include these logs for reference in our investigation.', 'wps-cookie-consent')}
          </p>
        </PanelRow>
        <PanelRow>
          <Flex
            ...
            <FlexItem>
              <Flex justify="flex-start">
                <FlexItem>
                  ...
                  >
                    {__('Copy to clipboard', 'wps-cookie-consent')}
                  </Button>
                </FlexItem>
                <FlexItem>
                  <Button
                    ...
                    isBusy={isClearing}
                  >
                    {__('Clear logs', 'wps-cookie-consent')}
                  </Button>
                  <ClearLogsModal
