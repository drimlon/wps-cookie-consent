((blockedScripts, cookieName) => {
  ...
  existingScripts.forEach((node) => {
    ...
    if (category !== null && !node.hasAttribute('data-wps-cc-no-block')) {
      if (isCategoryAllowed(category)) {
  ...
  document.createElement = function (...args) {
    ...
    if (category !== null && !element.hasAttribute('data-wps-cc-no-block')) {
      if (isCategoryAllowed(category)) {
        // Category is allowed, bail early
        return element;
      }
    ...
    Object.defineProperties(element, {
      src: {
        ...
        set(value) {
          ...
          if (cat !== null && !element.hasAttribute('data-wps-cc-no-block')) {
...
})(window.wpsCCBlockedScripts || [], window.wpsCCCookieName || '');
