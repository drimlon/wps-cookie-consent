...
class Migrator {
    ...
    private function migrate_1_1_2(): void {
        ...
        $necessary_table = $this->settings['wps_options']['cookie_table']['necessary'] ?? array();

        $this->settings['wps_options']['cookie_table']['necessary'] = $necessary_table;
    }
    ...
    private function migrate_1_2_0(): void {
        $record_consents = $this->settings['wps_options']['record_consents'] ?? true;

        $this->settings['wps_options']['record_consents'] = $record_consents;
    }
    ...
    private function migrate_1_3_0(): void {
        $colors = $this->settings['wps_options']['colors'] ?? array();
        ...
        $this->settings['wps_options']['colors']['btn-primary-hover-text']   = $primary_hover;
        $this->settings['wps_options']['colors']['btn-secondary-hover-text'] = $secondary_hover;
    }
    ...
    private function migrate_1_4_0(): void {
        ...
        $preferences_cookie_table = $this->settings['wps_options']['cookie_table']['preferences'] ?? array();

        $this->settings['wps_options']['cookie_table']['preferences'] = $preferences_cookie_table;
        ...
        $gcm = $this->settings['wps_options']['gcm'] ?? $default_gcm;

        $this->settings['wps_options']['gcm'] = $gcm;
    }
    ...
    private function migrate_1_5_0(): void {
        ...
        $hide_empty_categories = $this->settings['wps_options']['hide_empty_categories'] ?? false;

        $this->settings['wps_options']['hide_empty_categories'] = $hide_empty_categories;
        ...
        $font = $this->settings['wps_options']['font'] ?? $default_font;

        $this->settings['wps_options']['font'] = $font;
        ...
        $floating_button = $this->settings['wps_options']['floating_button'] ?? $default_floating_button;

        $this->settings['wps_options']['floating_button'] = $floating_button;
        ...
        $this->settings['wps_options']['colors']['btn-floating-bg']         = $btn_bg;
        $this->settings['wps_options']['colors']['btn-floating-icon']       = $btn_icon;
        $this->settings['wps_options']['colors']['btn-floating-hover-bg']   = $btn_hover_bg;
        $this->settings['wps_options']['colors']['btn-floating-hover-icon'] = $btn_hover_icon;
    }
