...
class Settings_Page extends Page implements Actions, Filters {
    ...
    protected function get_option_name(): string {
        return 'wps_cookie_consent_settings';
    }
    ...
    protected function get_page_title(): string {
        return __( 'Cookie Consent', 'wps-cookie-consent' );
    }
    ...
    protected function get_description(): string {
        return __( 'Adjust your cookie consent preferences.', 'wps-cookie-consent' );
    }
        ...
        wp_localize_script(
            ...
            array(
                ...
                'api'    => array(
                    ...
                    'logs_route'     => 'wps-cookie-consent/v1/logs',
                    'consents_route' => 'wps-cookie-consent/v1/consents',
                    'export_route'   => 'wps-cookie-consent/v1/export',
                    'nonce'          => wp_create_nonce( 'wps_cookie_consent_rest' ),
                ),
            )
        );
    }
    ...
    public function admin_footer_info( ?string $content ): ?string {
        ...
        return sprintf(
            '<span id="wps-cc-footer">%s</span>',
            sprintf(
                /* translators: 1: Developer name, 2: Link to the docs. */
                __( 'Developed by %1$s | For more information, read the %2$s.', 'wps-cookie-consent' ),
                sprintf(
                ...
                sprintf(
                    '<a href="%1$s" target="_blank" rel="noopener noreferrer">%2$s</a>',
                    esc_url( 'https://github.com/drimlon/wps-cookie-consent/wiki' ),
                    __( 'documentation', 'wps-cookie-consent' )
                )
            )
        );
    }
    ...
    public function admin_footer_version( ?string $content ): ?string {
        ...
        return sprintf(
            ...
            __( 'Version %s', 'wps-cookie-consent' ),
            esc_html( VERSION )
        );
    }
